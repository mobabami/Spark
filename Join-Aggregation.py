...
joinOrders = pruductsKeyValuePair.join(orderDetails.map(lambda l: (l["ProductId"],l)))

total = joinOrders.aggregate(0, lambda a,c: a + Decimal(c[1][1]["Quantity"]), lambda f,s: f+s)
#joinOrders.foreach(lambda l: print(l[1][1]["OrderId"]))
